    ...
    public class StatementChgController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(admStatementChg p)
        {
            try
            {
                ...
                if (get != null)
                {
                    if( get.Description == p.Description && get.StartingNo == p.StartingNo &&
                        get.EndingNo == p.EndingNo && get.ServiceId == p.ServiceId &&
                        get.ChgMetrix == p.ChgMetrix && get.ChgBasis == p.ChgBasis &&
                        get.Status == p.Status && get.CghAmount == p.CghAmount
                        )
                    {

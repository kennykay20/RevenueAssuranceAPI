    ...
    public class BusinessSearchController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(BusinessSearchDTO p)
        {
            try
            {
                ...
                var get = await _repoOprBusinessSearch.GetAsync(x => x.ItbId == _oprBusinessSearch.ItbId);

                if(get != null)
                {
                    if(get.AcctType == _oprBusinessSearch.AcctType && get.AcctName == _oprBusinessSearch.AcctName
                       && get.AcctNo == _oprBusinessSearch.AcctNo && get.CcyCode == _oprBusinessSearch.CcyCode
                       && get.AcctSic == _oprBusinessSearch.AcctSic && get.RsmId == _oprBusinessSearch.RsmId 
                       && get.ProcessingDeptId == _oprBusinessSearch.ProcessingDeptId)
                       {
                            ApiResponse.ResponseCode = -99;
                ...
                get.AcctType = _oprBusinessSearch.AcctType;
                get.AcctName = _oprBusinessSearch.AcctName;
                get.AcctNo = _oprBusinessSearch.AcctNo;
                get.CcyCode = _oprBusinessSearch.CcyCode;
                get.AcctSic = _oprBusinessSearch.AcctSic;
                get.RsmId = _oprBusinessSearch.RsmId; 
                get.ProcessingDeptId = _oprBusinessSearch.ProcessingDeptId;
                
                _repoOprBusinessSearch.Update(get);

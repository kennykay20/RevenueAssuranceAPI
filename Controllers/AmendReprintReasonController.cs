...
namespace RevAssuranceApi.Controllers
{
    ...
    //[Authorize]
    public class AmendReprintReasonController : ControllerBase
    {
        ...
        AppSettingsPath AppSettingsPath ;
         ...
         public AmendReprintReasonController(IConfiguration configuration,
        ...
        public async Task<IActionResult> GetAll(ParamLoadPage AnyAuth)
        {
            try
            {
                ...
                var rtn = new DapperDATAImplementation<admAmendReprintReason>();

                string script = "Select * from admAmendReprintReason";

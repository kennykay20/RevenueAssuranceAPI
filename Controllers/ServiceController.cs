    ...
    public class ServiceController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(admService p)
        {
            try
            {
                ...
                if(get != null)
                 {
                    if( get.ServiceDescription == p.ServiceDescription && get.ContDrAcctNo == p.ContDrAcctNo &&
                    get.ContDrAcctType == p.ContDrAcctType && get.ContDrAcctNarr == p.ContDrAcctNarr &&
                    get.ContCrAcctNo  == p.ContCrAcctNo && get.ContCrAcctType ==  p.ContCrAcctType &&
                    get.ContCrAcctNarr ==  p.ContCrAcctNarr &&
                    get.DefaultDept ==  p.DefaultDept && get.Status ==  p.Status &&
                    get.IncomeAcctNo == p.IncomeAcctNo && get.IncomeAcctType  ==  p.IncomeAcctType &&
                    get.Channel == p.Channel && get.Frequency == p.Frequency && get.Sequence == p.Sequence &&
                    get.RefPrefix == p.RefPrefix && get.CustAcctDrTC ==  p.CustAcctDrTC &&
                    get.GLAcctDrTC == p.GLAcctDrTC && get.CustAcctCrTC ==  p.CustAcctCrTC && get.GLAcctCrTC == p.GLAcctCrTC &&

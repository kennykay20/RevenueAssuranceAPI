...
namespace RevAssuranceApi.Controllers
{
    ...
    //[Authorize]
    public class ChqBookReqEncodingController : ControllerBase
    {
        ...
        public ChqBookReqEncodingController(
        ...
        public async Task<IActionResult> Encode(ChequeBookReqDTO p)
        {
            try
            {
                ...
                if(get != null){
                    if(get.EncodingStatus == "Processed"){
                        ApiResponse.ResponseCode = -99;
                        ApiResponse.ResponseMessage = "This Cheque is already Encoded!";

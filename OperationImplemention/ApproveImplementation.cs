        ...
        public async Task<ApiResponse> RejAllChecked(List<oprServiceCharges> ListoprServiceCharges, string _userName, int UserId, string RejIds)
        {
            ...
            foreach (var b in ListoprServiceCharges)
            {
                ...
                if (b.ServiceId == 3)
                {
                    ...
                    var getRec = await _repooprCounterChq.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectionDate = DateTime.Now;
                    _repooprCounterChq.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 4)
                {
                    ...
                    var getRec = await _repoOprStopChqRequest.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectionDate = DateTime.Now;
                    _repoOprStopChqRequest.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 5)
                {
                    ...
                    var getRec = await _repoOprBusinessSearch.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectionDate = DateTime.Now;
                    _repoOprBusinessSearch.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 6)
                {
                    ...
                    var getRec = await _repoOprAcctClosure.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectedDate = DateTime.Now;
                    _repoOprAcctClosure.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 7)
                {
                    ...
                    var getRec = await _repoOprCard.GetAsync(c => c.ItbId == b.ServiceItbId);
                ...
                if (b.ServiceId == 8)
                {
                    ...
                    var getRec = await _repooprStatementReq.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectedDate = DateTime.Now;
                    _repooprStatementReq.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 9)
                {
                    ...
                    var getRec = await _repoOprTradeReference.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectionDate = DateTime.Now;
                    _repoOprTradeReference.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 10)
                {
                    ...
                    var getRec = await _repoOprReferenceLetter.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectionDate = DateTime.Now;
                    _repoOprReferenceLetter.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 13)
                {
                    ...
                    var getRec = await _repoOprOverDraft.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectedDate = DateTime.Now;
                    _repoOprOverDraft.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 11 || b.ServiceId == 14 && b.ServiceId == 18 || b.ServiceId == 19 || b.ServiceId == 20 || b.ServiceId == 22 || b.ServiceId == 23)
                {
                ...
                if (b.ServiceId == 21)
                {
                    ...
                    var getRec = await _repooprPinReset.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectionDate = DateTime.Now;
                    _repooprPinReset.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);
                ...
                if (b.ServiceId == 16)
                {
                    ...
                    var getRec = await _repooprDocRetrieval.GetAsync(c => c.ItbId == b.ServiceItbId);
                    ...
                    getRec.RejectedBy = UserId;
                    getRec.RejectionDate = DateTime.Now;
                    _repooprDocRetrieval.Update(getRec);
                    int save = await _ApplicationdbContext.SaveChanges(UserId);

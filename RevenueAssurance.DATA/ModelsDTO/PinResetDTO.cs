...
namespace RevAssuranceApi.RevenueAssurance.DATA.ModelsDTO
{
    public class PinResetDTO
    {
        ...
        public oprPinReset oprPinReset { get; set;}   
        public List<oprPinReset> ListoprPinReset  { get; set;}      
        public List<oprServiceCharges> ListoprServiceCharge{ get; set;}
        public List<oprPinResetDTO> ListoprPinResetDTO { get; set; }
        ...
        public string TemplateContent { get; set; }
         public List<admPinItems> ListoprPinItems  {get; set;}

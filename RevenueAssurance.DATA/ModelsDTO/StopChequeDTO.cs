...
namespace RevAssuranceApi.RevenueAssurance.DATA.ModelsDTO
{
    public class StopChequeDTO
    {
        ...
        public OprStopChqRequest OprStopChqRequest { get; set;}   
        public List<OprStopChqRequest> ListOprStopChqRequest { get; set;}      
        public List<oprServiceCharges> ListoprServiceCharge{ get; set;}

        public List<OprStopChqRequestDTO> ListOprCounterChqDTO { get; set; }

    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
         //  services.AddAutoMapper(x=> x.AddProfile(new MappingsProfile()));
            ...
            #endregion      
            //string conString = Configuration["c:dbCon"];
           
           // conString =  Helper.SecurityDBConnection.DecryptDBConnectionString(conString);

            
           services.AddDbContext<ApplicationDbContext>(options =>
           options.UseSqlServer(Configuration.GetConnectionString("dbCon"))); 
            /* To replace "Configuration.GetConnectionString("DefaultConnection"))"
             from above to conString later when about to go Live */
            ...
            //     services.AddSingleton<Consul.IConsulClient, Consul.ConsulClient>(p => new Consul.ConsulClient(consulConfig =>
            //     {
           ...
           services.AddCors(options =>
            {
                ...
                //         .AllowAnyMethod()
                //         //.WithExposedHeaders("content-diposition")
                //         .AllowAnyHeader()
                //         .AllowCredentials()
